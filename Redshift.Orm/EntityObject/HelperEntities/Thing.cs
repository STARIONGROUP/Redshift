...
namespace Redshift.Orm.EntityObject
{
    ...
    /// </summary>
    public class Thing : EntityObject<Thing>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the type of the thing that the Uuid represents.
        /// </summary>
        ...
        {
            throw new InvalidOperationException("Things cannot be saved.");
        }
        ...
        {
            throw new InvalidOperationException("Things cannot be deleted.");
        }
    }
}
