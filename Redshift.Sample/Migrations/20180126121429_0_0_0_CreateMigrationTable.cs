#region Copyright
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="20180126121429_0_0_0_CreateMigrationTable.cs" company="RHEA System S.A.">
...
namespace Redshift.Sample.Migrations
{
    ...
    internal class CreateMigrationTable : MigrationBase
    {
        ...
        public override Guid Uuid 
        {
            get 
            { 
                return Guid.Parse("a34fc53f-a307-4a4d-b411-2e2c870a2b07"); 
            }
        }
        ...
        public override string FullName
        {
            get
            {
                return string.Format("{0}_{1}", "20180126121429", this.Name);
            }
        }
