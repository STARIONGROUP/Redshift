#region Copyright
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MigrationVersionC.cs" company="RHEA System S.A.">
...
namespace Redshift.Orm.Tests.HelperModel.Migrations
{
    ...
    public class MigrationVersionC : MigrationBase
    {
        public override string Description
        {
            get { return "A migration in version 1.1"; }
        }
        ...
        public override string FullName
        {
            get
            {
                return string.Format("{0}_{1}", "201509281003", this.Name);
            }
        }

        public override Guid Uuid
        {
            get { return Guid.Parse("A2C5F199-C90A-4703-B274-8085EBCE64C6"); }
        }
